...
description: "Reference library of proven n8n workflow architecture patterns. Covers webhooks, HTTP APIs, database ops, AI agents, and scheduled tasks. Use when designing workflow structure or choosing a pattern for a new build."
---
