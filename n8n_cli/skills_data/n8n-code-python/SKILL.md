...
description: "Write Python in n8n Code nodes (beta). Covers _input/_json/_node syntax and stdlib-only constraints. JS is preferred for 95% of cases. Use only when Python stdlib functions are specifically needed in n8n."
---
