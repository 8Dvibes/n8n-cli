...
description: "Configure n8n nodes with operation-aware property guidance. Covers required fields, property dependencies, and detail levels per node type. Use when setting up node parameters or understanding which fields an operation needs."
---
