...
description: "Validate and fix n8n expression syntax. Covers {{ }} double-brace syntax, $json/$node variables, and common mistakes. NOT Code node JS -- use /n8n-code-javascript for that. Use when debugging expressions."
---
